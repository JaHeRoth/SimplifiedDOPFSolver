...
from instances import grid_from_graph, trivial_instance, trivial_instance0, attach_derived_attr
from solving import solve, algorithm1, find_optimal_flow
...
benchmark(graph_type="circular ladder", largest_n=30, repeats=5, num_unique_n=30, dirname="output")
